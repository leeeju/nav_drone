...
# Validate that nav2_common_DIR is set
if(NOT DEFINED nav2_common_DIR)
  message(FATAL_ERROR "nav2_common_DIR is not defined. Ensure that nav2_common is properly sourced or built.")
endif()
