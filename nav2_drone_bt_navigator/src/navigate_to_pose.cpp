...
#include "nav2_drone_bt_navigator/action/compute_path_to_pose.h"
#include "nav2_drone_bt_navigator/action/follow_path.h"
#include "nav2_drone_bt_navigator/action/follow_waypoints.h"
#include "nav2_drone_bt_navigator/action/read_goal.h"
//#include "nav2_drone_bt_navigator/action/spin.h"
//#include "nav2_drone_bt_navigator/action/wait.h"

#include "nav2_drone_bt_navigator/control/round_robin.h"
#include "nav2_drone_bt_navigator/control/pipeline_sequence.h"
#include "nav2_drone_bt_navigator/control/recovery.h"
#include "nav2_drone_bt_navigator/decorator/rate_controller.h"
#include "nav2_drone_bt_navigator/action_status.h"
#include "nav2_drone_bt_navigator/pose_3D.h"
...
{
public:
  using NavigateToPose = nav2_drone_msgs::action::NavigateToPose;
...
private:
  ...
  */
  ...
  void execute(const std::shared_ptr<GoalHandleNavigateToPose> goal_handle)
  {
    ...
    bt_goal_msg.theta = nav2_drone_util::getYaw(wp.pose.orientation);
...
//        spin_action->init( node_ptr );
    ...
    while( ( tree.tickRoot() == NodeStatus::RUNNING) && rclcpp::ok() )
    {
      ...
      // Publish Feedback
      nav2_drone_util::getCurrentPose(current_pose, *tf_buffer_);
      ...
      distance_remaining = nav2_drone_util::euclidean_distance(current_pose, wp, true);
