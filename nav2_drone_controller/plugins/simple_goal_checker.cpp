...
//  double dyaw = nav2_drone_util::getDiff2Angles(
  ...
  geometry_msgs::msg::Twist & vel_tolerance)
{
  ...
  pose_tolerance.orientation =
    nav2_drone_util::orientationAroundZAxis(yaw_goal_tolerance_);
...
PLUGINLIB_EXPORT_CLASS(nav2_drone_controller::SimpleGoalChecker, nav2_drone_core::GoalChecker)
