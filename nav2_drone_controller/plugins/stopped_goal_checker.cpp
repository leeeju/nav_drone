...
#include <limits>
#include <vector>
#include "nav2_drone_controller/plugins/stopped_goal_checker.hpp"
...
PLUGINLIB_EXPORT_CLASS(nav2_drone_controller::StoppedGoalChecker, nav2_drone_core::GoalChecker)
