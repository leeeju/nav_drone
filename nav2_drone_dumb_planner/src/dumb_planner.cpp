...
namespace nav2_drone_dumb_planner
{
  class DumbPlanner : public nav2_drone_core::Planner
  {
    public:
...
PLUGINLIB_EXPORT_CLASS(nav2_drone_dumb_planner::DumbPlanner, nav2_drone_core::Planner)
